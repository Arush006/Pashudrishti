      ...
      {/* Header Section */}
        ...
        >
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            onClick={() => navigate('/doctor/mycases')}
            className="bg-blue-600 text-white rounded-xl p-6 text-center hover:bg-blue-700 transition-colors cursor-pointer"
          >
          ...
          <motion.button
            ...
            className="bg-purple-600 text-white rounded-xl p-6 text-center hover:bg-purple-700 transition-colors cursor-pointer"
          >
          ...
          <motion.button
            ...
            className="bg-green-600 text-white rounded-xl p-6 text-center hover:bg-green-700 transition-colors cursor-pointer"
          >
